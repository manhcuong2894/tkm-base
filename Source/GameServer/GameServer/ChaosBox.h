...
public:
	...
	void GetCountIncrease(CItem* lpItem, int& ItemCount);
	...
	void SocketItemMountSeedSphereMix(LPOBJ lpObj,WORD info);
	void SocketItemUnMountSeedSphereMix(LPOBJ lpObj, WORD info);
