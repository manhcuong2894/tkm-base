...
#if EFFECT_NEW_WARP
	std::vector<EFFECT_ENTRY> CustomEffectDinamic;
	std::vector<EFFECT_ENTRY> CustomEffectStatics;
	std::vector<EFFECT_ENTRY> CustomPetEffectDinamic;
	std::vector<EFFECT_ENTRY> CustomPetEffectStatics;
	std::vector<EFFECT_ENTRY> CustomMonsterEffectDinamic;
	std::vector<EFFECT_ENTRY> CustomMonsterEffectStatics;
#else
...
#if EFFECT_NEW_WARP
	// @nuevo effect list
	ReadScripted(".\\Common\\Effect\\CustomEffectDynamic.txt", CustomEffectDinamic, MAX_CUSTOM_EFFECT, EFFECT_ENTRY::parserItem);

	// @nuevo effect list
	ReadScripted(".\\Common\\Effect\\CustomEffectStatic.txt", CustomEffectStatics, MAX_CUSTOM_EFFECT, EFFECT_ENTRY::parserItem);

	// @nuevo pet effect list
	ReadScripted(".\\Common\\Effect\\CustomPetEffectDynamic.txt", CustomPetEffectDinamic, MAX_CUSTOM_EFFECT, EFFECT_ENTRY::parserItem);

	// @nuevo pet effect list
	ReadScripted(".\\Common\\Effect\\CustomPetEffectStatic.txt", CustomPetEffectStatics, MAX_CUSTOM_EFFECT, EFFECT_ENTRY::parserItem);

	// @nuevo monster effect list
	ReadScripted(".\\Common\\Effect\\CustomMonsterEffectDynamic.txt", CustomMonsterEffectDinamic, MAX_CUSTOM_EFFECT, EFFECT_ENTRY::parser);

	// @nuevo monster effect list
	ReadScripted(".\\Common\\Effect\\CustomMonsterEffectStatic.txt", CustomMonsterEffectStatics, MAX_CUSTOM_EFFECT, EFFECT_ENTRY::parser);
...
#if EFFECT_NEW_WARP
	writeVector(fp, CustomMonsterEffectDinamic);
	writeVector(fp, CustomMonsterEffectStatics);
#endif // EFFECT_NEW_WARP
	//------------------------------------------
