...
bool OBJECT::IsHideHorser()
{
	if (Type == MODEL_PLAYER
		&& (this->CurrentAction == PLAYER_STOP_RIDE_HORSE
			...
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_HORSE_SWORD
			|| this->CurrentAction == PLAYER_ATTACK_DARKHORSE
			|| this->CurrentAction == PLAYER_IDLE1_DARKHORSE
			|| this->CurrentAction == PLAYER_IDLE2_DARKHORSE
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_STRIKE
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_ATTACK_MAGIC
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_CROSSBOW
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_BOW
			))
	{
		return false;
	}
...
bool OBJECT::IsHideRiders()
{
	if (Type == MODEL_PLAYER
		&& (this->CurrentAction == PLAYER_STOP_RIDE
			...
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_SWORD
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_TWO_HAND_SWORD
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_SPEAR
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_SCYTHE
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_BOW
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_CROSSBOW
			|| this->CurrentAction == PLAYER_SKILL_RIDER
			|| this->CurrentAction == PLAYER_SKILL_RIDER_FLY
			|| this->CurrentAction == PLAYER_ATTACK_SKILL_SPEAR
			|| this->CurrentAction == PLAYER_FLY_RIDE
			|| this->CurrentAction == PLAYER_FLY_RIDE_WEAPON
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_STRIKE
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_TELEPORT
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_ATTACK_FLASH
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_ATTACK_MAGIC
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_BOW_UP
			|| this->CurrentAction == PLAYER_ATTACK_RIDE_CROSSBOW_UP
...
float OBJECT::GetCollision()
{
	//vec3_t center;
	//center[0] = (this->BoundingBoxMax[0] + this->BoundingBoxMin[0]) * 0.5f + this->Position[0];
	//center[1] = (this->BoundingBoxMax[1] + this->BoundingBoxMin[1]) * 0.5f + this->Position[1];
	//center[2] = (this->BoundingBoxMax[2] + this->BoundingBoxMin[2]) * 0.5f + this->Position[2];

	float dx = this->BoundingBoxMax[0] - this->BoundingBoxMin[0];
	float dy = this->BoundingBoxMax[1] - this->BoundingBoxMin[1];
	float dz = this->BoundingBoxMax[2] - this->BoundingBoxMin[2];
