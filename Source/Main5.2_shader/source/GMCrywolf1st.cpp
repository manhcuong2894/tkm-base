...
bool M34CryWolf1st::RenderCryWolf1stObjectVisual(OBJECT* o, BMD* b)
{
	...
	if (Change_weather > standlimit(70000))
	{
		weather = rand() % 3;
		Change_weather = 0;
	}
...
bool M34CryWolf1st::RenderCryWolf1stObjectMesh(OBJECT* o, BMD* b, int ExtraMon)
{
	...
	case 56:
	{
		...
		if (m_OccupationState == CRYWOLF_OCCUPATION_STATE_PEACE)
		{
			...
			if (rand() % 3 == 0)
				CreateEffectSync(BITMAP_MAGIC, o->Position, o->Angle, Light, 3, o, 4.0f);
		}
	}
	return true;
	case 41:
...
bool M34CryWolf1st::MoveCryWolf1stMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
		...
		if (o->CurrentAction == MONSTER01_ATTACK2)
		{
			...
			if (o->AnimationFrame >= 5.5f && o->AnimationFrame < (5.5f + fActionSpeed))
			{
				...
				for (int iu = 0; iu < 6; iu++)
				{
					...
					CreateEffectSync(MODEL_STONE2, EndPos1, o->Angle, o->Light);
				}
			}
		}
		else
	...
	case MODEL_MONSTER01 + 94:
	{
		...
		if (o->CurrentAction == MONSTER01_ATTACK1)
		{
			if (o->AnimationFrame >= 6.5f && o->AnimationFrame < (6.5f + fActionSpeed))
			{
				...
				CreateParticleSync(BITMAP_BLUE_BLUR, EndPos, o->Angle, Light, 1);
				CreateParticleSync(BITMAP_BLUE_BLUR, EndPos, o->Angle, Light, 1);
				...
				{
					CreateEffectSync(MODEL_BIG_STONE1, EndPos, o->Angle, o->Light, 10);
					CreateEffectSync(MODEL_STONE2, EndPos, o->Angle, o->Light);
				}
			}
		}
	...
	case MODEL_MONSTER01 + 89:
	{
		...
		if (o->CurrentAction == MONSTER01_ATTACK2)
		{
			...
			if (o->AnimationFrame >= 7.5f && o->AnimationFrame < (7.5f + fActionSpeed))
			{
				...
				Vector(1.f, 1.f, 1.f, Light);
				CreateEffectSync(BITMAP_CRATER, EndPos, o->Angle, o->Light, 2);
				CreateParticleSync(BITMAP_EXPLOTION, EndPos, o->Angle, Light, 2);
				for (int iu = 0; iu < 6; iu++)
					CreateEffectSync(MODEL_BIG_STONE1, EndPos, o->Angle, o->Light, 10);
			}
		}
	...
	case MODEL_MONSTER01 + 95:
	{
		...
		if (o->CurrentAction == MONSTER01_ATTACK1)
		{
			if (o->AnimationFrame >= 2.5f && o->AnimationFrame < (2.5f + fActionSpeed))
			{
				...
				if (o->Scale > 1.25f)
				{
					CreateEffectSync(MODEL_SKILL_FURY_STRIKE, EndPos, o->Angle, Light, 1, o, -1, 0, 1);
				}
			}
		}
		else if (o->CurrentAction == MONSTER01_WALK || o->CurrentAction == MONSTER01_RUN)
	...
	case MODEL_MONSTER01 + 97:
	{
		...
		if (o->CurrentAction == MONSTER01_ATTACK2 && o->AnimationFrame >= 4.0f && o->AnimationFrame <= 6.0f)
		{
			...
			CreateEffectSync(MODEL_PIERCING2, o->Position, o->Angle, Light, 1);
		}
	}
	break;
	...
	case MODEL_MONSTER01 + 99:
	{
		if (m_CrywolfState == CRYWOLF_STATE_START)
		{
			...
			{
				CreateEffectSync(MODEL_ARROW_TANKER, o->Position, o->Angle, o->Light, 1, o, o->PKKey);
				o->Timer = 0;
				return true;
			}
		}
	...
	case MODEL_MONSTER01 + 92:
	{
		if ((o->CurrentAction == MONSTER01_ATTACK1 || o->CurrentAction == MONSTER01_ATTACK2))
		{
			...
			if (o->CurrentAction == MONSTER01_ATTACK2 && (o->AnimationFrame > 4.5f && o->AnimationFrame < 5.0f))
				CreateEffectSync(MODEL_DARK_ELF_SKILL, o->Position, o->Angle, o->Light, 2, o);
		...
		else if (o->CurrentAction == MONSTER01_ATTACK3)
		{
			...
			CreateParticleSync(BITMAP_SMOKE, Position, o->Angle, Light, 27, 1.0f);
			Vector(0.3f, 0.3f, 0.4f, Light);
			CreateParticleSync(BITMAP_LIGHT + 1, Position, o->Angle, Light, 2, 0.8f);
			CreateParticleSync(BITMAP_LIGHT + 1, Position, o->Angle, Light, 2, 0.6f);
		}
	}
	break;
	case MODEL_MONSTER01 + 93:
	{
		if ((o->CurrentAction == MONSTER01_ATTACK1 || o->CurrentAction == MONSTER01_ATTACK2))
		{
			...
			if (o->AnimationFrame > 4.5f && o->AnimationFrame < 5.0f)
			{
				...
				CreateEffectSync(MODEL_DEATH_SPI_SKILL, Position, Angle, Pos, 0, to);
				CreateEffectSync(MODEL_DEATH_SPI_SKILL, Position, Angle, Pos, 1, to);
				Angle[2] = o->Angle[2] - 90;
				CreateEffectSync(MODEL_DEATH_SPI_SKILL, Position, Angle, Pos, 0, to);
				CreateEffectSync(MODEL_DEATH_SPI_SKILL, Position, Angle, Pos, 1, to);
			}
...
bool M34CryWolf1st::RenderCryWolf1stMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
	...
	case MODEL_CRYWOLF_ALTAR5:
	{
		...
		if (g_isCharacterBuff(o, eBuff_CrywolfAltarContracted))
		{
			...
			CreateParticleSync(BITMAP_EFFECT, o->Position, o->Angle, o->Light);
			CreateParticleSync(BITMAP_EFFECT, o->Position, o->Angle, o->Light, 1);
		}
