...
uint8_t CHARACTER::GetLive()
{
	return (uint8_t)this->Object.Live;
}

void CHARACTER::SetLive(uint8_t fLive)
{
	this->Object.Live = fLive;
}

uint8_t CHARACTER::GetVisible()
{
	return this->Object.Visible;
}

void CHARACTER::SetVisible(uint8_t bVisible)
{
	this->Object.Visible = bVisible;
}
