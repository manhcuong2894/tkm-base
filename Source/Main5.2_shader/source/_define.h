...
#define INVENTORY_EXT1_SIZE				(96) // max extension 1
#define INVENTORY_EXT2_SIZE				(128) // max extension 2
#define INVENTORY_EXT3_SIZE				(160) // max extension 3
#define INVENTORY_EXT4_SIZE				(192) // max extension 4

#define MAX_MY_INVENTORY_INDEX			(192)
#define MAX_MY_SHOP_INVENTORY_INDEX		(224)

#define INVENTORY_SHOP_INDEX			(204)
#define INVENTORY_SHOP_MAX				(236)
