...
namespace SEASON3B
{
	...
	private:
		...
		CNewUIEventProgresstime*			m_NewUIEventTimeList;
	...
	public:
		...
		CNewUIEventProgresstime* GetUI_NewUIEventTimeList() const;
...
#define g_pMixInvenExpansion	(SEASON3B::CNewUISystem::GetInstance()->GetUI_NewUIMixExpansion())
