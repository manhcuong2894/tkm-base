...
bool tagITEM::CheckUseJewel()
{
	if ((Kind2 >= ItemKind2::SWORD && Kind2 <= ItemKind2::BOOTS
		&& Kind2 != ItemKind2::BOLT
		&& Kind2 != ItemKind2::ARROW)
		|| Kind2 == ItemKind2::RUNIC_MACE
		|| Kind2 == ItemKind2::SHORT_SWORD
		|| Kind2 == ItemKind2::MAGIC_GUN
		|| Kind2 == ItemKind2::MAGIC_STICK
		|| Kind2 == ItemKind2::MAGIC_ORB
...
void CGMItemMng::OpenFile(char* FileName)
{
	...
	//g_ConsoleDebug->Write(5, "SIZE: %d [Resistance: %d][PowerATTK: %d]", Size, offsetof(Script_Item, Resistance), offsetof(Script_Item, PowerATTK));
