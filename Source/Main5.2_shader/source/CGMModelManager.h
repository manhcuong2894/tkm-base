...
public:
	...
	static CGMModelManager* Instance();
private:
	std::vector<BMD> modelMemoryDump;
};

extern BMD* ClientModels;
extern BMD* GetModelDataUnsafe(int i);

#define gmClientModels			(CGMModelManager::Instance())