...
bool CGMProtect::LoadMainFileInfo(MAIN_FILE_INFO& mainInfo, std::string& filePath)
{
	...
	if (fp != nullptr)
	{
		...
		else
		{
			...
			//@items effect
			/*+013*/ gItemEffect->LoadEffects(fp, RENDER_PARTICLE);
			/*+014*/ gItemEffect->LoadEffects(fp, RENDER_SPRITE);
			//@pets effect
			/*+015*/ gItemEffect->LoadEffects(fp, RENDER_PARTICLE);
			/*+016*/ gItemEffect->LoadEffects(fp, RENDER_SPRITE);
			//@monster effect
			/*+017*/ gMonsterEffect->LoadEffects(fp, RENDER_PARTICLE);
			/*+018*/ gMonsterEffect->LoadEffects(fp, RENDER_SPRITE);
