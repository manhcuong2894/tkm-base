...
bool CCharacterManager::GetEquipedBookType(const int Type)
{
	const int weaponIndex = (Type - MODEL_ITEM);
	int weaponkind = GMItemMng->GetKind2(weaponIndex);

	return (weaponkind == ItemKind2::BOOK);
}
