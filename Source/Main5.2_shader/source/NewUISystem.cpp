...
bool SEASON3B::CNewUISystem::LoadMainSceneInterface()
{
	...
	m_NewUIEventTimeList = new CNewUIEventProgresstime;
...
void SEASON3B::CNewUISystem::Show(DWORD dwKey)
{
	...
	if (!(dwKey == SEASON3B::INTERFACE_FRIEND
		|| dwKey == SEASON3B::INTERFACE_COMMAND_LIST
		|| dwKey == SEASON3B::INTERFACE_INVENTORY
		|| dwKey == SEASON3B::INTERFACE_INVENTORY_EXTENSION
		)
		&& this->IsVisible(SEASON3B::INTERFACE_MIXINVENTORY))
	{
	...
	if (m_pNewUIMng)
	{
		...
		case SEASON3B::INTERFACE_FRIEND:
			m_pNewMainFrameWindow->SetBtnState(SEASON3B::MAINFRAME_BTN_FRIEND, true);
		...
		case SEASON3B::INTERFACE_PET:
			...
			m_pNewMainFrameWindow->SetBtnState(SEASON3B::MAINFRAME_BTN_CHAINFO, true);
		...
		case SEASON3B::INTERFACE_MYQUEST:
			...
			{
				m_pNewMyQuestInfoWindow->SetPos(WinOpen2, 0);
			}
			if (IsVisible(SEASON3B::INTERFACE_INVENTORY))
			{
				Hide(SEASON3B::INTERFACE_INVENTORY);
			...
			{
				m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_GUILD, true);
			}
			break;
		case SEASON3B::INTERFACE_INVENTORY:
			HideGroupBeforeOpenInterface();

			m_pNewMainFrameWindow->SetBtnState(SEASON3B::MAINFRAME_BTN_MYINVEN, true);

			if (IsVisible(SEASON3B::INTERFACE_CHARACTER))
				m_pNewMyInventory->SetPos(WinOpen2, 0);
		...
		case SEASON3B::INTERFACE_CHARACTER:
			...
			m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_CHAINFO, true);
		...
		case SEASON3B::INTERFACE_MIXINVENTORY:
			HideAllGroupA();
			m_pNewMixInventory->OpeningProcess();
			m_pNewUIMng->ShowInterface(SEASON3B::INTERFACE_INVENTORY);
			m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_MYINVEN, true);
			break;
		...
		case SEASON3B::INTERFACE_PARTY:
			...
			if (GMProtect->LookAndFeelType() == 1 || GMProtect->LookAndFeelType() == 2)
			{
				m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_PARTY, true);
			}
			break;
		...
		case SEASON3B::INTERFACE_WINDOW_MENU:
			...
			m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_WINDOW, true);
			break;
		...
		case SEASON3B::INTERFACE_INGAMESHOP:
			...
			m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_PARTCHARGE, true);
		...
		case SEASON3B::INTERFACE_MACRO_OFICIAL:
			...
			break;
		case SEASON3B::INTERFACE_TOP_RANKING:
			m_NewUIRankTop->OpenningProcess();
			HideGroupOpenInterface(INTERFACE_TOP_RANKING);
			break;
...
void SEASON3B::CNewUISystem::Hide(DWORD dwKey)
{
	if (m_pNewUIMng)
	{
		...
		{
		case SEASON3B::INTERFACE_FRIEND:
			m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_FRIEND, false);
			m_pNewFriendWindow->HideAllWindow(TRUE, TRUE);
			break;
		case SEASON3B::INTERFACE_CHARACTER:
			m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_CHAINFO, false);
			if (IsVisible(SEASON3B::INTERFACE_MYQUEST))
			{
			...
			if (IsVisible((SEASON3B::INTERFACE_INVENTORY)))
			{
				m_pNewMyInventory->SetPos(WinOpen1, 0);
			}
			if (IsVisible((SEASON3B::INTERFACE_PET)))
			{
				Hide(SEASON3B::INTERFACE_PET);
		...
		case SEASON3B::INTERFACE_INVENTORY:
			...
			m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_MYINVEN, false);
		...
		default:
			if (dwKey != SEASON3B::INTERFACE_MYSHOP_INVENTORY && dwKey != SEASON3B::INTERFACE_PURCHASESHOP_INVENTORY)
			{
				...
				case SEASON3B::INTERFACE_PARTY:
					...
					if (GMProtect->LookAndFeelType() == 1 || GMProtect->LookAndFeelType() == 2)
					{
						m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_PARTY, false);
					}
					break;
				case SEASON3B::INTERFACE_MYQUEST:
					...
					if (GMProtect->LookAndFeelType() == 3 || GMProtect->LookAndFeelType() == 4)
					{
						m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_GUILD, false);
					}
					break;
				case SEASON3B::INTERFACE_SENATUS:
				...
				case SEASON3B::INTERFACE_COMMAND:
					...
					break;
				case SEASON3B::INTERFACE_WINDOW_MENU:
					m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_WINDOW, false);
					break;
				default:
					if (dwKey != SEASON3B::INTERFACE_OPTION)
					{
						...
						case SEASON3B::INTERFACE_INGAMESHOP:
							...
							m_pNewMainFrameWindow->SetBtnState(MAINFRAME_BTN_PARTCHARGE, false);
							break;
						case SEASON3B::INTERFACE_DOPPELGANGER_NPC:
...
void SEASON3B::CNewUISystem::HideGroupOpenInterface(DWORD dwKey)
{
	DWORD dwGroupC[] =
	{
		...
		SEASON3B::INTERFACE_TOP_RANKING,
		0,
	};
...
CNewUIEventProgresstime* SEASON3B::CNewUISystem::GetUI_NewUIEventTimeList() const
{
