...
void SEASON3B::CNewUIOptionWindow::RenderContents()
{
	...
	g_pRenderText->RenderText(RenderFrameX + 30, RenderFrameY + 32, "Resolutions:"); //--

	g_pRenderText->RenderText(RenderFrameX + 30, RenderFrameY + 157, "Font Size:"); //--
	...
	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 94, "Render Effect", 0, 15); //-- Slide Help

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 112, "Render Equipment", 0, 15); //-- Slide Help

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 130, "Render Terrain", 0, 15); //-- Slide Help

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 148, "Render Objects", 0, 15); //-- Slide Help
