...
void OpenPlayers()
{
	...
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_TWO_HAND_SWORD_TWO)->PlaySpeed = 0.24f;
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_ONETOONE)->PlaySpeed = 0.45f;
	...
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_STRIKE)->PlaySpeed = 0.2f;
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_TELEPORT)->PlaySpeed = 0.28f;

	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_RIDE_STRIKE)->PlaySpeed = 0.3f;
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_RIDE_TELEPORT)->PlaySpeed = 0.3f;
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_RIDE_HORSE_SWORD)->PlaySpeed = 0.28f;
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_RIDE_ATTACK_FLASH)->PlaySpeed = 0.3f;
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_RIDE_ATTACK_MAGIC)->PlaySpeed = 0.3f;
	gmClientModels->GetPlayerModelAction(PLAYER_ATTACK_DARKHORSE)->PlaySpeed = 0.2f;
